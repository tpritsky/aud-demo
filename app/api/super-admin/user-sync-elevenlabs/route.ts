...
/**
 * POST /api/super-admin/user-sync-elevenlabs
 * Body: { userId: string } — sync ElevenLabs for the target user's clinic (super_admin only).
 */
export async function POST(request: NextRequest) {
  try {
    ...
    console.error('POST /api/super-admin/user-sync-elevenlabs', e)
